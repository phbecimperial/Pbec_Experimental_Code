...
aligned_pic = np.array(Image.open(r'C:\Data\2024\PumpSpotLocation\31_07_aligned.bmp'), dtype=float)

pic = np.array(Image.open(r'C:\Data\2024\PumpSpotLocation\31_07_disp1.bmp'), dtype=float)
...
crop_point[0] -= -7 #Fix displacement
crop_point[1] += 13
print(crop_point)
