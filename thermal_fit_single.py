...
aligned_pic = np.array(Image.open(r'C:\Data\2024\PumpSpotLocation\1_08_aligned.bmp'), dtype=float)

pic = np.array(Image.open(r'C:\Data\2024\PumpSpotLocation\1_08_disp_2.bmp'), dtype=float)
...
crop_point[0] -= 3 #Fix displacement
crop_point[1] -= 9
print(crop_point)
