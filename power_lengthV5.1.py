...
components.update({"lasermeter": comp.Thor_PowerMeter(num_power_readings=100, bs_factor=3/7, laser=True)})
components.update({"powermeter": comp.Thor_PowerMeter(power_meter_usb_name='USB0::0x1313::0x8078::P0046773::INSTR', num_power_readings=100, bs_factor=0.25)})
